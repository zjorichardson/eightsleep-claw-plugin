...
import { EightSleepClient } from "../src/client.js";
import type { SleepDay } from "../src/types.js";
...
function getCredentials() {
  ...
  if (!email || !password) {
    ...
    console.error("Set them in your shell or create .env file in this directory");
    process.exit(1);
  }
...
USAGE:
  npx ts-node eightsleep.ts <command> [options]
...
DEVICE OPTIONS:
  user                Get user info
  device              Get device info (default)
